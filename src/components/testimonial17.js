                  ...
                  {props.review1 ?? (
                    <Fragment>
                      <span className="testimonial17-text34">
                        Hipsters Cafe is my go-to place for delicious coffee and
                        pastries. The ambiance is cozy, and the staff is always
                        friendly.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.review2 ?? (
                    <Fragment>
                      <span className="testimonial17-text28">
                        I love the modern vibe of Hipsters Cafe. The menu offers
                        a great variety, and the ordering process is seamless.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  <div className="testimonial17-container17">
                    ...
                    <span className="thq-body-small">
                      {props.author3Position ?? (
                        <Fragment>
                          <span className="testimonial17-text33">Designer</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                  ...
                  {props.review3 ?? (
                    <Fragment>
                      <span className="testimonial17-text36">
                        Hipsters Cafe exceeded my expectations. The attention to
                        detail in every dish is remarkable. I highly recommend
                        it!
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.review4 ?? (
                    <Fragment>
                      <span className="testimonial17-text37">
                        As a busy entrepreneur, I appreciate the quick service
                        at Hipsters Cafe. The quality of the food keeps me
                        coming back.
                      </span>
                    </Fragment>
                  )}
...
Testimonial17.defaultProps = {
  ...
  author3Src:
    'https://images.unsplash.com/photo-1533757751343-978d1ebc2d6a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NzAxMTI3MHw&ixlib=rb-4.1.0&q=80&w=1080',
  author2Alt: 'John Doe - Tech Enthusiast',
  author4Alt: 'Michael Johnson - Entrepreneur',
  content1: undefined,
